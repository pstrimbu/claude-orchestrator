...
9. **Destroy workers with summaries** — always use `orch-destroy <name> --summary "60-120 char description of work completed"`
10. **Report back** to the user with a summary of what was done. Mark tracker issues Done after verification.
