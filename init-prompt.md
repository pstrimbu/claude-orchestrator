...
- `orch-clock start "description"` / `orch-clock stop` — track your own active time
- `orch-reload` — re-read init-prompt.md and CLAUDE.md (also available via `Ctrl-b r`)

## When the user gives you a goal

1. **Start your clock** — `orch-clock start "Brief description of goal"`
...
12. **Stop your clock** — `orch-clock stop`
...
- **Always use `orch-clock`** — start when you begin work, stop when you finish
